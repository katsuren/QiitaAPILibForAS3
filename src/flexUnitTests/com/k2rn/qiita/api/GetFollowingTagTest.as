package flexUnitTests.com.k2rn.qiita.api
{
    ...
    public class GetFollowingTagTest
    {		
        [Before]
        ...
        {
            var api:GetFollowingTag = new GetFollowingTag(TestHelper.API_END_POINT);
            api.userId              = "katsuren";
        ...
        {
            var api:GetFollowingTag = new GetFollowingTag("http://some.invalid.end.point/");
