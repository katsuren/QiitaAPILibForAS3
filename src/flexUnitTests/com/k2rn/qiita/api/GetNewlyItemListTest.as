package flexUnitTests.com.k2rn.qiita.api
{
    ...
    public class GetNewlyItemListTest
    {		
        [Before]
        ...
        {
            var api:GetNewlyItemList = new GetNewlyItemList(TestHelper.API_END_POINT);
        ...
        {
            var api:GetNewlyItemList = new GetNewlyItemList("http://some.invalid.end.point/");
