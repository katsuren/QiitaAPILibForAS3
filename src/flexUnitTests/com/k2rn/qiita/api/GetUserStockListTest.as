package flexUnitTests.com.k2rn.qiita.api
{
    ...
    public class GetUserStockListTest
    {		
        [Before]
        ...
        {
            var api:GetUserStockList = new GetUserStockList(TestHelper.API_END_POINT);
            api.userId = "katsuren";
        ...
        {
            var api:GetUserStockList = new GetUserStockList("http://some.invalid.end.point/");
