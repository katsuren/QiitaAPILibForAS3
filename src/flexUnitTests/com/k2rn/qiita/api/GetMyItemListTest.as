package flexUnitTests.com.k2rn.qiita.api
{
    ...
    public class GetMyItemListTest
    {		
        [Before]
        ...
        {
            var api:GetMyItemList = new GetMyItemList(TestHelper.API_END_POINT);
        ...
        {
            var api:GetMyItemList = new GetMyItemList("http://some.invalid.end.point/");
