package flexUnitTests.com.k2rn.qiita.api
{
    ...
    public class GetFollowingUserTest
    {		
        [Before]
        ...
        {
            var api:GetFollowingUser = new GetFollowingUser(TestHelper.API_END_POINT);
            api.userId              = "katsuren";
        ...
        {
            var api:GetFollowingUser = new GetFollowingUser("http://some.invalid.end.point/");
