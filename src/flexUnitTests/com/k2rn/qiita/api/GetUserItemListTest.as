package flexUnitTests.com.k2rn.qiita.api
{
    ...
    public class GetUserItemListTest
    {		
        [Before]
        ...
        {
            var api:GetUserItemList = new GetUserItemList(TestHelper.API_END_POINT);
            api.userId = "katsuren";
        ...
        {
            var api:GetUserItemList = new GetUserItemList("http://some.invalid.end.point/");
